...
public class ClientTest {
    public static void main(String[] args) throws Exception{
        ...
        factory.setServiceClass(IMilitaryActivitiy.class);
        factory.setAddress("http://localhost:8080/ais/services/ma");
        factory.getOutInterceptors().addAll(list);
        IMilitaryActivitiy maService = (IMilitaryActivitiy) factory.create();
        MilitaryActivitiyBo maBo = new MilitaryActivitiyBo();
        maBo.setSourceId(123456789);
        maBo.setDestinationId(987654321);
        maBo.setActivitiyTheme(4);
        maBo.setDurationType(0);
        List<Integer> latList = new ArrayList<Integer>();
        latList.add(34624525);
        maBo.setLatitudeList(latList);
        List<Integer> lonList = new ArrayList<Integer>();
        lonList.add(124546232);
        maBo.setLongitudeList(lonList);
        maBo.setDateTime1(System.currentTimeMillis());
        maBo.setDateTime2(System.currentTimeMillis());
        maBo.setPrecautions(2);
        maService.maBroadcastService(maBo);
