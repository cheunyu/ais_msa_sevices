...
public class ClientTest {
    public static void main(String[] args) throws Exception{
        ...
        factory.setServiceClass(IOceanService.class);
        factory.setAddress("");
        factory.getOutInterceptors().addAll(list);
        IOceanService oceanService = (IOceanService) factory.create();
        ...
        List<Ocean> oceanList = oceanService.oceanService(gc);
        for(int i=0;i<oceanList.size();i++) {
            System.out.println(oceanList.get(i).toString());
        }
