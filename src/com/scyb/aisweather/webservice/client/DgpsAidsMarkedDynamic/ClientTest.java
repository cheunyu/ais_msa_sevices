...
public class ClientTest {
    public static void main(String[] args) throws Exception{
        ...
        factory.setServiceClass(IDgpsAidsMarkedDynamic.class);
        factory.setAddress("http://localhost:8080/services/dgpsAmd");
        factory.getOutInterceptors().addAll(list);
        IDgpsAidsMarkedDynamic dAmdService = (IDgpsAidsMarkedDynamic) factory.create();
        DgpsDynamicBo ddBo = new DgpsDynamicBo();
        ddBo.setStatus(8);
        ddBo.setRange(3);
        ddBo.setLatitude(34624525);
        ddBo.setLongitude(124546232);
        ddBo.setLaunch(2980);
        ddBo.setDestinationId(987654321);
        ddBo.setSourceId(123456789);
        dAmdService.dgpsAmdBroadcastService(ddBo);
